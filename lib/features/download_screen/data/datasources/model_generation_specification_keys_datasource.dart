...
@injectable
class ModelGenerationSpecificationKeysDataSource {
  deleteAllModelGenerationSpecificationKeysInDatabase({required String tableName,required languageId}) async {
    final response =
