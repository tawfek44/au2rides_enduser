...
@injectable
class FuelOctaneNumberDataSource {
  deleteAllFuelOctaneNumberInDatabase({required String tableName,required languageId}) async {
    final response =
        await Au2ridesDatabase.instance.clearAllData(tableName: tableName,languageId: languageId);
    return response;
  }

  getAllFuelOctaneNumberFromNetworkDatabase(
