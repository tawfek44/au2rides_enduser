...
@injectable
class WorkflowStatusesDataSource {
  deleteAllWorkflowStatusesInDatabase({required String tableName,required languageId}) async {
    final response =
  ...
  saveAllWorkflowStatusesInDatabase(
