...
part of 'fuel_octane_number_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FuelOctaneNumberEntity _$FuelOctaneNumberEntityFromJson(
        Map<String, dynamic> json) =>
    FuelOctaneNumberEntity(
      fuelOctaneNumberId: json['fuel_octane_number_id'] as int,
      languageId: json['language_id'] as int,
      fuelOctaneNumber: json['fuel_octane_number'] as String,
    );

Map<String, dynamic> _$FuelOctaneNumberEntityToJson(
        FuelOctaneNumberEntity instance) =>
    <String, dynamic>{
