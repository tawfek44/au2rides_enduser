...
import 'package:au2rides/core/repositories/user_repository.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i29.UserRepository>(_i29.UserRepository.create(
        gh<_i18.IPrefsManager>(instanceName: 'prefs')));
    gh.factory<_i30.CheckPrimaryDataCubit>(() => _i30.CheckPrimaryDataCubit(
          gh<_i6.CheckPrimaryDataUseCase>(),
          gh<_i22.IsDownloadedUseCase>(),
        ));
    gh.factory<_i31.ClearCountryUseCase>(
        () => _i31.ClearCountryUseCase(gh<_i8.CountryRepository>()));
    gh.factory<_i32.ClearCurrencyUseCase>(
        () => _i32.ClearCurrencyUseCase(gh<_i12.CurrencyRepository>()));
    gh.factory<_i33.ClearGenderUseCase>(
        () => _i33.ClearGenderUseCase(gh<_i15.GenderRepository>()));
    gh.factory<_i34.CountryCubit>(() => _i34.CountryCubit(
          gh<_i10.CountryUseCase>(),
          gh<_i27.SaveCountriesUseCase>(),
          gh<_i31.ClearCountryUseCase>(),
          gh<_i32.ClearCurrencyUseCase>(),
        ));
    gh.factory<_i35.CurrencyCubit>(() => _i35.CurrencyCubit(
          gh<_i32.ClearCurrencyUseCase>(),
          gh<_i17.GetAllCurrencyUseCase>(),
          gh<_i28.SaveCurrenciesInLocalDbUseCase>(),
        ));
    gh.factory<_i36.DownloadGenderUseCase>(
        () => _i36.DownloadGenderUseCase(gh<_i15.GenderRepository>()));
    gh.factory<_i37.GenderCubit>(() => _i37.GenderCubit(
          gh<_i33.ClearGenderUseCase>(),
          gh<_i36.DownloadGenderUseCase>(),
        ));
    gh.factory<_i38.GetLanguagesUseCase>(
        () => _i38.GetLanguagesUseCase(gh<_i24.LanguageRepository>()));
    gh.factory<_i39.LanguageCubit>(
        () => _i39.LanguageCubit(gh<_i38.GetLanguagesUseCase>()));
    return this;
  }
}
