...
import 'package:au2rides/core/repositories/user_repository.dart' as _i88;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i88.UserRepository>(_i88.UserRepository.create(
        gh<_i39.IPrefsManager>(instanceName: 'prefs')));
    gh.factory<_i89.WeatherUnitsDataSource>(
        () => _i89.WeatherUnitsDataSource());
    gh.factory<_i90.WeatherUnitsRepository>(() =>
        _i91.WeatherUnitsRepositoryImpl(gh<_i89.WeatherUnitsDataSource>()));
    gh.factory<_i92.AcquisitionTypesCubit>(() => _i92.AcquisitionTypesCubit(
          gh<_i10.ClearAcquisitionTypesUseCase>(),
          gh<_i33.GetAllAcquisitionTypesUseCase>(),
          gh<_i72.SaveAcquisitionTypesInLocalDbUseCase>(),
        ));
    gh.factory<_i93.CheckPrimaryDataCubit>(() => _i93.CheckPrimaryDataCubit(
          gh<_i9.CheckPrimaryDataUseCase>(),
          gh<_i43.IsDownloadedUseCase>(),
        ));
    gh.factory<_i94.ClearCountryUseCase>(
        () => _i94.ClearCountryUseCase(gh<_i12.CountryRepository>()));
    gh.factory<_i95.ClearCurrencyUseCase>(
        () => _i95.ClearCurrencyUseCase(gh<_i16.CurrencyRepository>()));
    gh.factory<_i96.ClearEngineFuelTypesUseCase>(() =>
        _i96.ClearEngineFuelTypesUseCase(gh<_i19.EngineFuelTypesRepository>()));
    gh.factory<_i97.ClearEngineTransmissionTypesUseCase>(() =>
        _i97.ClearEngineTransmissionTypesUseCase(
            gh<_i22.EngineTransmissionTypesRepository>()));
    gh.factory<_i98.ClearFuelBrandsUseCase>(
        () => _i98.ClearFuelBrandsUseCase(gh<_i25.FuelBrandsRepository>()));
    gh.factory<_i99.ClearFuelConsumptionUnitTypesUseCase>(() =>
        _i99.ClearFuelConsumptionUnitTypesUseCase(
            gh<_i28.FuelConsumptionUnitTypesRepository>()));
    gh.factory<_i100.ClearGenderUseCase>(
        () => _i100.ClearGenderUseCase(gh<_i31.GenderRepository>()));
    gh.factory<_i101.ClearMetricUnitsUseCase>(
        () => _i101.ClearMetricUnitsUseCase(gh<_i48.MetricUnitsRepository>()));
    gh.factory<_i102.ClearMonthUseCase>(
        () => _i102.ClearMonthUseCase(gh<_i51.MonthRepository>()));
    gh.factory<_i103.ClearPaymentMethodsUseCase>(() =>
        _i103.ClearPaymentMethodsUseCase(gh<_i55.PaymentMethodsRepository>()));
    gh.factory<_i104.ClearPressureUnitsUseCase>(() =>
        _i104.ClearPressureUnitsUseCase(gh<_i58.PressureUnitsRepository>()));
    gh.factory<_i105.ClearRecurrencePeriodTypesUseCase>(() =>
        _i105.ClearRecurrencePeriodTypesUseCase(
            gh<_i61.RecurrencePeriodTypesRepository>()));
    gh.factory<_i106.ClearReminderTypeServiceUseCase>(() =>
        _i106.ClearReminderTypeServiceUseCase(
            gh<_i64.ReminderTypeServiceRepository>()));
    gh.factory<_i107.ClearReminderTypeUseCase>(() =>
        _i107.ClearReminderTypeUseCase(gh<_i67.ReminderTypesRepository>()));
    gh.factory<_i108.ClearRideTypesUseCase>(
        () => _i108.ClearRideTypesUseCase(gh<_i70.RideTypesRepository>()));
    gh.factory<_i109.ClearWeatherUnitsUseCase>(() =>
        _i109.ClearWeatherUnitsUseCase(gh<_i90.WeatherUnitsRepository>()));
    gh.factory<_i110.CountryCubit>(() => _i110.CountryCubit(
          gh<_i14.CountryUseCase>(),
          gh<_i73.SaveCountriesUseCase>(),
          gh<_i94.ClearCountryUseCase>(),
          gh<_i95.ClearCurrencyUseCase>(),
        ));
    gh.factory<_i111.CurrencyCubit>(() => _i111.CurrencyCubit(
          gh<_i95.ClearCurrencyUseCase>(),
          gh<_i34.GetAllCurrencyUseCase>(),
          gh<_i74.SaveCurrenciesInLocalDbUseCase>(),
        ));
    gh.factory<_i112.DownloadGenderUseCase>(
        () => _i112.DownloadGenderUseCase(gh<_i31.GenderRepository>()));
    gh.factory<_i113.DownloadPaymentMethodsUseCase>(() =>
        _i113.DownloadPaymentMethodsUseCase(
            gh<_i55.PaymentMethodsRepository>()));
    gh.factory<_i114.DownloadRideTypesUseCase>(
        () => _i114.DownloadRideTypesUseCase(gh<_i70.RideTypesRepository>()));
    gh.factory<_i115.DownloadWeatherUnitsUseCase>(() =>
        _i115.DownloadWeatherUnitsUseCase(gh<_i90.WeatherUnitsRepository>()));
    gh.factory<_i116.EngineFuelTypesCubit>(() => _i116.EngineFuelTypesCubit(
          gh<_i96.ClearEngineFuelTypesUseCase>(),
          gh<_i35.GetAllEngineFuelTypesUseCase>(),
          gh<_i75.SaveEngineFuelTypesInLocalDbUseCase>(),
        ));
    gh.factory<_i117.EngineTransmissionTypesCubit>(
        () => _i117.EngineTransmissionTypesCubit(
              gh<_i97.ClearEngineTransmissionTypesUseCase>(),
              gh<_i36.GetAllEngineTransmissionTypesUseCase>(),
              gh<_i76.SaveEngineTransmissionTypesInLocalDbUseCase>(),
            ));
    gh.factory<_i118.FuelBrandsCubit>(() => _i118.FuelBrandsCubit(
          gh<_i98.ClearFuelBrandsUseCase>(),
          gh<_i37.GetAllFuelBrandUseCase>(),
          gh<_i77.SaveFuelBrandInLocalDbUseCase>(),
        ));
    gh.factory<_i119.FuelConsumptionUnitTypesCubit>(
        () => _i119.FuelConsumptionUnitTypesCubit(
              gh<_i99.ClearFuelConsumptionUnitTypesUseCase>(),
              gh<_i38.GetAllFuelConsumptionUnitTypesUseCase>(),
              gh<_i78.SaveFuelConsumptionUnitTypesInLocalDbUseCase>(),
            ));
    gh.factory<_i120.GenderCubit>(() => _i120.GenderCubit(
          gh<_i100.ClearGenderUseCase>(),
          gh<_i112.DownloadGenderUseCase>(),
          gh<_i79.SaveGenderDataInLocalDb>(),
        ));
    gh.factory<_i121.GetAllMetricUnitsUseCase>(
        () => _i121.GetAllMetricUnitsUseCase(gh<_i48.MetricUnitsRepository>()));
    gh.factory<_i122.GetAllPressureUnitsUseCase>(() =>
        _i122.GetAllPressureUnitsUseCase(gh<_i58.PressureUnitsRepository>()));
    gh.factory<_i123.GetAllRecurrencePeriodTypesUseCase>(() =>
        _i123.GetAllRecurrencePeriodTypesUseCase(
            gh<_i61.RecurrencePeriodTypesRepository>()));
    gh.factory<_i124.GetAllReminderTypeServiceUseCase>(() =>
        _i124.GetAllReminderTypeServiceUseCase(
            gh<_i64.ReminderTypeServiceRepository>()));
    gh.factory<_i125.GetLanguagesUseCase>(
        () => _i125.GetLanguagesUseCase(gh<_i45.LanguageRepository>()));
    gh.factory<_i126.GetMonthsUseCase>(
        () => _i126.GetMonthsUseCase(gh<_i51.MonthRepository>()));
    gh.factory<_i127.GetReminderTypesUseCase>(() =>
        _i127.GetReminderTypesUseCase(gh<_i67.ReminderTypesRepository>()));
    gh.factory<_i128.LanguageCubit>(
        () => _i128.LanguageCubit(gh<_i125.GetLanguagesUseCase>()));
    gh.factory<_i129.MetricUnitsCubit>(() => _i129.MetricUnitsCubit(
          gh<_i101.ClearMetricUnitsUseCase>(),
          gh<_i121.GetAllMetricUnitsUseCase>(),
          gh<_i80.SaveMetricUnitsInLocalDbUseCase>(),
        ));
    gh.factory<_i130.MonthCubit>(() => _i130.MonthCubit(
          gh<_i126.GetMonthsUseCase>(),
          gh<_i81.SaveMonthsUseCase>(),
          gh<_i102.ClearMonthUseCase>(),
        ));
    gh.factory<_i131.PaymentMethodsCubit>(() => _i131.PaymentMethodsCubit(
          gh<_i103.ClearPaymentMethodsUseCase>(),
          gh<_i113.DownloadPaymentMethodsUseCase>(),
          gh<_i82.SavePaymentMethodsDataInLocalDbUseCase>(),
        ));
    gh.factory<_i132.PressureUnitsCubit>(() => _i132.PressureUnitsCubit(
          gh<_i14.CountryUseCase>(),
          gh<_i83.SavePressureUnitsInLocalDbUseCase>(),
          gh<_i104.ClearPressureUnitsUseCase>(),
          gh<_i122.GetAllPressureUnitsUseCase>(),
        ));
    gh.factory<_i133.RecurrencePeriodTypesCubit>(
        () => _i133.RecurrencePeriodTypesCubit(
              gh<_i105.ClearRecurrencePeriodTypesUseCase>(),
              gh<_i123.GetAllRecurrencePeriodTypesUseCase>(),
              gh<_i84.SaveRecurrencePeriodTypesInLocalDbUseCase>(),
            ));
    gh.factory<_i134.ReminderTypeServiceCubit>(
        () => _i134.ReminderTypeServiceCubit(
              gh<_i106.ClearReminderTypeServiceUseCase>(),
              gh<_i124.GetAllReminderTypeServiceUseCase>(),
              gh<_i85.SaveReminderTypeServiceInLocalDbUseCase>(),
            ));
    gh.factory<_i135.ReminderTypesCubit>(() => _i135.ReminderTypesCubit(
          gh<_i127.GetReminderTypesUseCase>(),
          gh<_i86.SaveReminderTypesUseCase>(),
          gh<_i107.ClearReminderTypeUseCase>(),
        ));
    gh.factory<_i136.RideTypesCubit>(() => _i136.RideTypesCubit(
          gh<_i108.ClearRideTypesUseCase>(),
          gh<_i114.DownloadRideTypesUseCase>(),
          gh<_i87.SaveRideTypesDataInLocalDbUseCase>(),
        ));
    gh.factory<_i137.SaveWeatherUnitsDataInLocalDb>(() =>
        _i137.SaveWeatherUnitsDataInLocalDb(gh<_i90.WeatherUnitsRepository>()));
    gh.factory<_i138.WeatherUnitsCubit>(() => _i138.WeatherUnitsCubit(
          gh<_i109.ClearWeatherUnitsUseCase>(),
          gh<_i115.DownloadWeatherUnitsUseCase>(),
          gh<_i137.SaveWeatherUnitsDataInLocalDb>(),
        ));
    return this;
  }
}
