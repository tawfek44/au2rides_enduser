...
import 'package:au2rides/core/network_state/network_state.dart' as _i34;
import 'package:au2rides/core/repositories/user_repository.dart' as _i52;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i31.MonthDataSource>(() => _i31.MonthDataSource());
    gh.factory<_i32.MonthRepository>(
        () => _i33.MonthRepositoryImpl(gh<_i31.MonthDataSource>()));
    gh.factory<_i34.NetworkInfo>(() => _i34.NetworkInfoImpl.create());
    gh.factory<_i35.PaymentMethodsDataSource>(
        () => _i35.PaymentMethodsDataSource());
    gh.factory<_i36.PaymentMethodsRepository>(() =>
        _i37.PaymentMethodsRepositoryImpl(gh<_i35.PaymentMethodsDataSource>()));
    gh.factory<_i38.PressureUnitsDataSource>(
        () => _i38.PressureUnitsDataSource());
    gh.factory<_i39.PressureUnitsRepository>(() =>
        _i40.PressureUnitsRepositoryImpl(gh<_i38.PressureUnitsDataSource>()));
    gh.factory<_i41.RideTypesDataSource>(() => _i41.RideTypesDataSource());
    gh.factory<_i42.RideTypesRepository>(
        () => _i43.RideTypesRepositoryImpl(gh<_i41.RideTypesDataSource>()));
    gh.factory<_i44.SaveAcquisitionTypesInLocalDbUseCase>(() =>
        _i44.SaveAcquisitionTypesInLocalDbUseCase(
            gh<_i4.AcquisitionTypesRepository>()));
    gh.factory<_i45.SaveCountriesUseCase>(
        () => _i45.SaveCountriesUseCase(gh<_i12.CountryRepository>()));
    gh.factory<_i46.SaveCurrenciesInLocalDbUseCase>(() =>
        _i46.SaveCurrenciesInLocalDbUseCase(gh<_i16.CurrencyRepository>()));
    gh.factory<_i47.SaveGenderDataInLocalDb>(
        () => _i47.SaveGenderDataInLocalDb(gh<_i19.GenderRepository>()));
    gh.factory<_i48.SaveMonthsUseCase>(
        () => _i48.SaveMonthsUseCase(gh<_i32.MonthRepository>()));
    gh.factory<_i49.SavePaymentMethodsDataInLocalDbUseCase>(() =>
        _i49.SavePaymentMethodsDataInLocalDbUseCase(
            gh<_i36.PaymentMethodsRepository>()));
    gh.factory<_i50.SavePressureUnitsInLocalDbUseCase>(() =>
        _i50.SavePressureUnitsInLocalDbUseCase(
            gh<_i39.PressureUnitsRepository>()));
    gh.factory<_i51.SaveRideTypesDataInLocalDbUseCase>(() =>
        _i51.SaveRideTypesDataInLocalDbUseCase(gh<_i42.RideTypesRepository>()));
    gh.singleton<_i52.UserRepository>(_i52.UserRepository.create(
        gh<_i23.IPrefsManager>(instanceName: 'prefs')));
    gh.factory<_i53.WeatherUnitsDataSource>(
        () => _i53.WeatherUnitsDataSource());
    gh.factory<_i54.WeatherUnitsRepository>(() =>
        _i55.WeatherUnitsRepositoryImpl(gh<_i53.WeatherUnitsDataSource>()));
    gh.factory<_i56.AcquisitionTypesCubit>(() => _i56.AcquisitionTypesCubit(
          gh<_i10.ClearAcquisitionTypesUseCase>(),
          gh<_i21.GetAllAcquisitionTypesUseCase>(),
          gh<_i44.SaveAcquisitionTypesInLocalDbUseCase>(),
        ));
    gh.factory<_i57.CheckPrimaryDataCubit>(() => _i57.CheckPrimaryDataCubit(
          gh<_i9.CheckPrimaryDataUseCase>(),
          gh<_i27.IsDownloadedUseCase>(),
        ));
    gh.factory<_i58.ClearCountryUseCase>(
        () => _i58.ClearCountryUseCase(gh<_i12.CountryRepository>()));
    gh.factory<_i59.ClearCurrencyUseCase>(
        () => _i59.ClearCurrencyUseCase(gh<_i16.CurrencyRepository>()));
    gh.factory<_i60.ClearGenderUseCase>(
        () => _i60.ClearGenderUseCase(gh<_i19.GenderRepository>()));
    gh.factory<_i61.ClearMonthUseCase>(
        () => _i61.ClearMonthUseCase(gh<_i32.MonthRepository>()));
    gh.factory<_i62.ClearPaymentMethodsUseCase>(() =>
        _i62.ClearPaymentMethodsUseCase(gh<_i36.PaymentMethodsRepository>()));
    gh.factory<_i63.ClearPressureUnitsUseCase>(() =>
        _i63.ClearPressureUnitsUseCase(gh<_i39.PressureUnitsRepository>()));
    gh.factory<_i64.ClearRideTypesUseCase>(
        () => _i64.ClearRideTypesUseCase(gh<_i42.RideTypesRepository>()));
    gh.factory<_i65.ClearWeatherUnitsUseCase>(
        () => _i65.ClearWeatherUnitsUseCase(gh<_i54.WeatherUnitsRepository>()));
    gh.factory<_i66.CountryCubit>(() => _i66.CountryCubit(
          gh<_i14.CountryUseCase>(),
          gh<_i45.SaveCountriesUseCase>(),
          gh<_i58.ClearCountryUseCase>(),
          gh<_i59.ClearCurrencyUseCase>(),
        ));
    gh.factory<_i67.CurrencyCubit>(() => _i67.CurrencyCubit(
          gh<_i59.ClearCurrencyUseCase>(),
          gh<_i22.GetAllCurrencyUseCase>(),
          gh<_i46.SaveCurrenciesInLocalDbUseCase>(),
        ));
    gh.factory<_i68.DownloadGenderUseCase>(
        () => _i68.DownloadGenderUseCase(gh<_i19.GenderRepository>()));
    gh.factory<_i69.DownloadPaymentMethodsUseCase>(() =>
        _i69.DownloadPaymentMethodsUseCase(
            gh<_i36.PaymentMethodsRepository>()));
    gh.factory<_i70.DownloadRideTypesUseCase>(
        () => _i70.DownloadRideTypesUseCase(gh<_i42.RideTypesRepository>()));
    gh.factory<_i71.DownloadWeatherUnitsUseCase>(() =>
        _i71.DownloadWeatherUnitsUseCase(gh<_i54.WeatherUnitsRepository>()));
    gh.factory<_i72.GenderCubit>(() => _i72.GenderCubit(
          gh<_i60.ClearGenderUseCase>(),
          gh<_i68.DownloadGenderUseCase>(),
          gh<_i47.SaveGenderDataInLocalDb>(),
        ));
    gh.factory<_i73.GetAllPressureUnitsUseCase>(() =>
        _i73.GetAllPressureUnitsUseCase(gh<_i39.PressureUnitsRepository>()));
    gh.factory<_i74.GetLanguagesUseCase>(
        () => _i74.GetLanguagesUseCase(gh<_i29.LanguageRepository>()));
    gh.factory<_i75.GetMonthsUseCase>(
        () => _i75.GetMonthsUseCase(gh<_i32.MonthRepository>()));
    gh.factory<_i76.LanguageCubit>(
        () => _i76.LanguageCubit(gh<_i74.GetLanguagesUseCase>()));
    gh.factory<_i77.MonthCubit>(() => _i77.MonthCubit(
          gh<_i75.GetMonthsUseCase>(),
          gh<_i48.SaveMonthsUseCase>(),
          gh<_i61.ClearMonthUseCase>(),
        ));
    gh.factory<_i78.PaymentMethodsCubit>(() => _i78.PaymentMethodsCubit(
          gh<_i62.ClearPaymentMethodsUseCase>(),
          gh<_i69.DownloadPaymentMethodsUseCase>(),
          gh<_i49.SavePaymentMethodsDataInLocalDbUseCase>(),
        ));
    gh.factory<_i79.PressureUnitsCubit>(() => _i79.PressureUnitsCubit(
          gh<_i14.CountryUseCase>(),
          gh<_i50.SavePressureUnitsInLocalDbUseCase>(),
          gh<_i63.ClearPressureUnitsUseCase>(),
          gh<_i73.GetAllPressureUnitsUseCase>(),
        ));
    gh.factory<_i80.RideTypesCubit>(() => _i80.RideTypesCubit(
          gh<_i64.ClearRideTypesUseCase>(),
          gh<_i70.DownloadRideTypesUseCase>(),
          gh<_i51.SaveRideTypesDataInLocalDbUseCase>(),
        ));
    gh.factory<_i81.SaveWeatherUnitsDataInLocalDb>(() =>
        _i81.SaveWeatherUnitsDataInLocalDb(gh<_i54.WeatherUnitsRepository>()));
    gh.factory<_i82.WeatherUnitsCubit>(() => _i82.WeatherUnitsCubit(
          gh<_i65.ClearWeatherUnitsUseCase>(),
          gh<_i71.DownloadWeatherUnitsUseCase>(),
          gh<_i81.SaveWeatherUnitsDataInLocalDb>(),
        ));
    return this;
  }
}
