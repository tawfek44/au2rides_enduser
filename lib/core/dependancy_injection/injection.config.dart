...
import 'package:au2rides/core/repositories/user_repository.dart' as _i34;
...
import 'package:au2rides/features/redirection_screen/data/repositories/gender_repository.dart'
    as _i16;
import 'package:au2rides/features/redirection_screen/data/repositories/ride_types_repository.dart'
    as _i29;
...
import 'package:au2rides/features/redirection_screen/domain/usecase/gender/save_gender_data_usecase.dart'
    as _i32;
import 'package:au2rides/features/redirection_screen/domain/usecase/ride_types/clear_ride_types_local_usecase.dart'
    as _i42;
import 'package:au2rides/features/redirection_screen/domain/usecase/ride_types/download_ride_types_network_usecase.dart'
    as _i47;
import 'package:au2rides/features/redirection_screen/domain/usecase/ride_types/save_ride_types_data_usecase.dart'
    as _i33;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i27.RideTypesDataSource>(() => _i27.RideTypesDataSource());
    gh.factory<_i28.RideTypesRepository>(
        () => _i29.RideTypesRepositoryImpl(gh<_i27.RideTypesDataSource>()));
    gh.factory<_i30.SaveCountriesUseCase>(
        () => _i30.SaveCountriesUseCase(gh<_i8.CountryRepository>()));
    gh.factory<_i31.SaveCurrenciesInLocalDbUseCase>(() =>
        _i31.SaveCurrenciesInLocalDbUseCase(gh<_i12.CurrencyRepository>()));
    gh.factory<_i32.SaveGenderDataInLocalDb>(
        () => _i32.SaveGenderDataInLocalDb(gh<_i15.GenderRepository>()));
    gh.factory<_i33.SaveRideTypesDataInLocalDbUseCase>(() =>
        _i33.SaveRideTypesDataInLocalDbUseCase(gh<_i28.RideTypesRepository>()));
    gh.singleton<_i34.UserRepository>(_i34.UserRepository.create(
        gh<_i18.IPrefsManager>(instanceName: 'prefs')));
    gh.factory<_i35.WeatherUnitsDataSource>(
        () => _i35.WeatherUnitsDataSource());
    gh.factory<_i36.WeatherUnitsRepository>(() =>
        _i37.WeatherUnitsRepositoryImpl(gh<_i35.WeatherUnitsDataSource>()));
    gh.factory<_i38.CheckPrimaryDataCubit>(() => _i38.CheckPrimaryDataCubit(
          gh<_i6.CheckPrimaryDataUseCase>(),
          gh<_i22.IsDownloadedUseCase>(),
        ));
    gh.factory<_i39.ClearCountryUseCase>(
        () => _i39.ClearCountryUseCase(gh<_i8.CountryRepository>()));
    gh.factory<_i40.ClearCurrencyUseCase>(
        () => _i40.ClearCurrencyUseCase(gh<_i12.CurrencyRepository>()));
    gh.factory<_i41.ClearGenderUseCase>(
        () => _i41.ClearGenderUseCase(gh<_i15.GenderRepository>()));
    gh.factory<_i42.ClearRideTypesUseCase>(
        () => _i42.ClearRideTypesUseCase(gh<_i28.RideTypesRepository>()));
    gh.factory<_i43.ClearWeatherUnitsUseCase>(
        () => _i43.ClearWeatherUnitsUseCase(gh<_i36.WeatherUnitsRepository>()));
    gh.factory<_i44.CountryCubit>(() => _i44.CountryCubit(
          gh<_i10.CountryUseCase>(),
          gh<_i30.SaveCountriesUseCase>(),
          gh<_i39.ClearCountryUseCase>(),
          gh<_i40.ClearCurrencyUseCase>(),
        ));
    gh.factory<_i45.CurrencyCubit>(() => _i45.CurrencyCubit(
          gh<_i40.ClearCurrencyUseCase>(),
          gh<_i17.GetAllCurrencyUseCase>(),
          gh<_i31.SaveCurrenciesInLocalDbUseCase>(),
        ));
    gh.factory<_i46.DownloadGenderUseCase>(
        () => _i46.DownloadGenderUseCase(gh<_i15.GenderRepository>()));
    gh.factory<_i47.DownloadRideTypesUseCase>(
        () => _i47.DownloadRideTypesUseCase(gh<_i28.RideTypesRepository>()));
    gh.factory<_i48.DownloadWeatherUnitsUseCase>(() =>
        _i48.DownloadWeatherUnitsUseCase(gh<_i36.WeatherUnitsRepository>()));
    gh.factory<_i49.GenderCubit>(() => _i49.GenderCubit(
          gh<_i41.ClearGenderUseCase>(),
          gh<_i46.DownloadGenderUseCase>(),
          gh<_i32.SaveGenderDataInLocalDb>(),
        ));
    gh.factory<_i50.GetLanguagesUseCase>(
        () => _i50.GetLanguagesUseCase(gh<_i24.LanguageRepository>()));
    gh.factory<_i51.LanguageCubit>(
        () => _i51.LanguageCubit(gh<_i50.GetLanguagesUseCase>()));
    gh.factory<_i52.RideTypesCubit>(() => _i52.RideTypesCubit(
          gh<_i42.ClearRideTypesUseCase>(),
          gh<_i47.DownloadRideTypesUseCase>(),
          gh<_i33.SaveRideTypesDataInLocalDbUseCase>(),
        ));
    gh.factory<_i53.SaveWeatherUnitsDataInLocalDb>(() =>
        _i53.SaveWeatherUnitsDataInLocalDb(gh<_i36.WeatherUnitsRepository>()));
    gh.factory<_i54.WeatherUnitsCubit>(() => _i54.WeatherUnitsCubit(
          gh<_i43.ClearWeatherUnitsUseCase>(),
          gh<_i48.DownloadWeatherUnitsUseCase>(),
          gh<_i53.SaveWeatherUnitsDataInLocalDb>(),
        ));
    return this;
  }
}
